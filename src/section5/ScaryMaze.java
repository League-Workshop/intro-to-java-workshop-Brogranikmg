...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze2 = ImageIO.read(getClass().getResource("maze2.png"));
		maze3 = ImageIO.read(getClass().getResource("maze3.png"));
	...
	public void mouseMoved(MouseEvent e) {
		...
		if (mouseColor == bg) {
			...
			scare();
			JOptionPane.showMessageDialog(null, "brush ur teeth ;)");
		}
		//13. If the mouse is on the end color
		if (mouseColor == -1900544) {
			if (curmaze == 0) {
				maze = maze2;
				curmaze++;
			} else if (curmaze == 1) {
